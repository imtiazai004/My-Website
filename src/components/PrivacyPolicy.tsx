      ...
      <main className="relative z-20 pt-36 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-12">
            <a
              href="/"
              className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-white/40 hover:text-brand-accent transition-colors mb-8"
            >
              ← Back to Home
            </a>
            ...
            <p className="text-white/40 text-sm">ProfitScout Chrome Extension · Last updated: June 14, 2026</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
              <h2 className="text-white font-bold text-base mb-3" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                1. Data We Collect
              </h2>
            ...
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                ...
                Language API (<span className="text-white/80">generativelanguage.googleapis.com</span>).
            ...
            <div className="bg-brand-accent/5 border border-brand-accent/20 rounded-2xl p-6">
              <h2 className="text-white font-bold text-base mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                7. Contact
              </h2>
              <div className="space-y-2 text-sm">
                <p className="text-white/90 font-semibold">Imtiaz Ahmad</p>
                <p className="text-white/50">AI Soft Tech Solution</p>
                <a
