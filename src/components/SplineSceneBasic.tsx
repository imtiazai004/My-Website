    ...
    <section className="relative w-full h-screen overflow-hidden bg-[#f8fafc]">
      ...
      <div className="relative z-30 h-full w-full flex flex-col justify-center items-center text-center px-6 pt-24 pointer-events-none">
        <div className="max-w-3xl mx-auto pointer-events-auto">
          ...
          >
            Turning Your Vibes Into <span className="text-brand-accent font-bold">Soft Tech</span><br />That Solve Your <span className="text-brand-accent font-bold">Problems</span>
          </motion.h1>
