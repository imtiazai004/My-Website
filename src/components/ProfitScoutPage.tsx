    ...
    <div className="min-h-screen selection:bg-brand-accent selection:text-white scroll-smooth relative overflow-x-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-center">
            {[
              ...
              >
                <div className="text-4xl font-bold text-brand-accent mb-1" style={{ fontFamily: 'Poppins, sans-serif' }}>{stat.value}</div>
      ...
      <section className="relative z-20 py-24 px-6 border-t border-slate-900/[0.07]">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-3" style={{ fontFamily: 'Poppins, sans-serif' }}>
              See it in action
            </h2>
      ...
      <section className="relative z-20 py-24 px-6 border-t border-slate-900/[0.07]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-bold text-slate-900 mb-16" style={{ fontFamily: 'Poppins, sans-serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="text-6xl font-bold text-slate-900/5 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>{s.step}</div>
      ...
      <section className="relative z-20 py-24 px-6 border-t border-slate-900/[0.07]">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-slate-900" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Common questions
            </h2>
          </div>
      ...
      <section className="relative z-20 py-24 px-6 border-t border-slate-900/[0.07]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-bold text-slate-900 mb-4" style={{ fontFamily: 'Poppins, sans-serif' }}>
